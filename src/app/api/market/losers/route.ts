...
export async function GET() {
  try {
    const symbols = ["WIPRO.NS", "TECHM.NS", "DRREDDY.NS", "HCLTECH.NS", "SUNPHARMA.NS", "INFY.NS", "TCS.NS", "CIPLA.NS"].join(",");
    ...
    const quotes = (data?.quoteResponse?.result || [])
      ...
      .sort((a: { changePercent: number }, b: { changePercent: number }) => a.changePercent - b.changePercent);
